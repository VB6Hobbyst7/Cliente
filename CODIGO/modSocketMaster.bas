...
Private Declare Function api_LoadLibrary _
                Lib "kernel32" _
                Alias "LoadLibraryA" (ByVal lpLibFileName As String) As Long

Private Declare Function api_SetTimer _
                Lib "user32" _
                Alias "SetTimer" (ByVal hwnd As Long, _
                                  ByVal nIDEvent As Long, _
                                  ByVal uElapse As Long, _
                                  ByVal lpTimerFunc As Long) As Long

Private Declare Function api_KillTimer _
                Lib "user32" _
                Alias "KillTimer" (ByVal hwnd As Long, _
